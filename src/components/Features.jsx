            ...
            <div className='flex flex-col justify-center items-center overflow-hidden'>
                ...
                <div className='flex-center flex-col sm:px-10 '>
                    <div className='relative h-[50vh] w-full flex items-center'>
                        <video playsInline id='explore-video' className='w-full h-full object-cover object-center' preload='none' muted autoPlay ref={videoRef}>
                    ...
                    <div className='flex flex-col w-full relative'>
                        ...
                        <div className='feature-text-container'>
                            ...
                            <div className='flex-1 flex-center'>
                                <p className='feature-text g_text'>Titanium has one of the best strenght-to-weight ratios of any metal, making these our {' '}
                                    <span className='text-white'>
