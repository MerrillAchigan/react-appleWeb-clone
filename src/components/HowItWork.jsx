    ...
    <section className='common-padding'>
        <div className='screen-max-width'>
            ...
            <div className='flex flex-col items-center'>
                ...
                <p className='hiw-subtitle'>Its' here. The biggest redesign in the history of Apple GPUs.</p>
            </div>
            <div className='mt-10 md:mt-20 mb-14'>
                ...
                <p className='font-semibold flex-center text-gray-600 mt-3'>Honkai:Star Rail</p>
                </div>
                <div className='hiw-text-container'>
                    <div className='flex flex-1 justify-center flex-col'>
                        <p className='hiw-text g_fadeIn'>A17 Pro is an entirely new class of iPhone chip that deliver our {' '}
